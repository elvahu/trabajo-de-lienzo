...
function movimientoopcion5(){
	if(numero5>=800) {numero5=0}else{numero5+=10}
		for (var i = 0; i <= numero5; i+=220) {
			if(numero5>=i) {ubicacionx5=i}
		}
	if(numero5>=800) {numero3=0}else{numero5+=5}
...
ctx.drawImage(sprite,ubicacion5,0,150,350,ubicacion5,300,200,200);
